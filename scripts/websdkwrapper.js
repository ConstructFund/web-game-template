runOnStartup(async runtime => {
	...
	execJs.CreateFunction("deepCopyObjWithoutFunctions", ["obj"], `
	...
	execJs.CreateFunction("handleInit", ["args"], `
		...
		globalThis.WebSdkWrapper.init(name, debug, data).then(() => {
			...
			globalThis.WebSdkWrapper.dispatch("onInit", {
			  ...
			  currentSdk: globalThis.skymenExexJSOnDom._OnCallFunction({"name": "deepCopyObjWithoutFunctions", "args": [globalThis.WebSdkWrapper.currentSdk]}),
			})
		}).catch(e => {
