  ...
  const Wrapper = {
    ...
    async init(name, debug = false, data = {}) {
      return new Promise((resolve, reject) => {
        ...
        globalThis.skymenExexJSOnDom.CallFunction("handleInit", [
          [name, debug, data],
        ]);
      });
    },
